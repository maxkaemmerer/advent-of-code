...
pub fn parse_token<'a>(string: &'a str, token_name: &'a str, start_delimiter: &'a str, end_delimiter: char) -> Option<Token<'a>> {
...
pub fn parse_token_before<'a>(string: &'a str, token_name: &'a str, start_delimiter: &'a str, end_delimiter: char) -> Option<Token<'a>> {
...
mod tests {
   ...
   pub fn should_parse_after() {
      assert_eq!(Some(("Game", "3")), parse_token("Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red", "Game", " ", ':'));
   }
   #[test]
   pub fn should_parse_before() {
      assert_eq!(Some(("green", "2")), parse_token_before("1 red, 2 green, 6 blue", "green", " ", ' '));
      assert_eq!(Some(("red", "1")), parse_token_before("Game 100: 1 red, 2 green, 6 blue", "red", " ", ' '));
      assert_eq!(Some(("blue", "6")), parse_token_before("1 red, 2 green, 6 blue", "blue", " ", ' '));
   }
}